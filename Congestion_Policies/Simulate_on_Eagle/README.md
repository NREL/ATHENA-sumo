...
```
If above command returns text containig 'CANCELLED DUE TO TIME LIMIT', the job was terminated before completing. You will need to edit the script file by increasing the allocation time requested, and resubmit job (go back to step 11).
